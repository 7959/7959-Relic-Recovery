...
public class DistanceNavigation {
    ...
    final double rangeSensorDistanceFromEdge = RobotControl.distanceUnit.toCm(5);
    ...
    //Gets distance in the standard unit of use in RobotControl
    public double getWallDistance(){
        return wallSensor.getDistance(RobotControl.distanceUnit) - RobotControl.distanceUnit.fromCm(rangeSensorDistanceFromEdge);
    }
