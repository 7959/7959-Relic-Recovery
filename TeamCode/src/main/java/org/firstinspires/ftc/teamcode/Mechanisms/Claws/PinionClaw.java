...
public class PinionClaw implements ClawInterface {
    Servo leftS;
    Servo rightS;
    double rightstart;
    double leftstart;
    ...
    public PinionClaw(HardwareMap hw, String name, String name2, double startR, double startL, double stopR, double stopL){
        rightstart = startR;
        leftstart = startL;
        rightstop = stopR;
        leftstop = stopL;
